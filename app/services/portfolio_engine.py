...
class PortfolioEngine:
    ...
    def evaluate(self, req: PortfolioEvaluateRequest) -> PortfolioEvaluateResponse:
        ...
        benchmark = returns_from_prices([x["close"] for x in self.p1.get_historical(settings.benchmark_symbol, exchanges[symbols[0]], 252)])
        ...
        for s in symbols:
            ...
            feat = self.p2.get_features(s, exchanges[s])
